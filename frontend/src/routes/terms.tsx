...
export const Route = createFileRoute("/terms")({
  component: TermsPage,
  head: () => ({
    meta: [{ title: "Terms & Conditions - Future Form Manufacturing" }],
  }),
})
...
function TermsPage() {
  return (
    <LegalLayout title="Terms and Conditions" updated="March 27, 2026">
      ...
      <P>
        We are Future Form Manufacturing LLC. (“Company,” “we,” “us,” “our”), a
        company registered in Nevada, United States at 599 East Nugget Ave,
        Sparks, NV 89431. We operate the website https://futureform.com (the
      ...
      <P>
        You can contact us by phone at (+1)7753583663, email at
        info@futureform.com, or by mail to 599 East Nugget Ave, Sparks, NV
        89431, United States.
      </P>
      <P>
        These Legal Terms constitute a legally binding agreement made between
        you and Future Form Manufacturing LLC. concerning your access to and use
      ...
      <P>
        ...
        these Legal Terms. All users who are minors in the jurisdiction in which
      ...
      <P>
        ...
        regulation. Those persons who choose to access the Services from other
        locations do so on their own initiative and are solely responsible for
        compliance with local laws. The Services are not tailored to comply with
        industry-specific regulations (HIPAA, FISMA, etc.).
      </P>
      ...
      <P>
        ...
        in the Services (the “Content”), as well as the trademarks, service
        marks, and logos contained therein (the “Marks”). The Content and Marks
        are provided “AS IS” for your personal, non-commercial use or internal
      ...
      <P>
        ...
        non-commercial use or internal business purpose. By sending us any
      ...
      <P>
        ...
        not access the Services through automated or non-human means; (4) you
      ...
      <P>
        ...
        agree not to, among other things:
      </P>
      <UL
        items={[
      ...
      <P>
        We reserve the right, but not the obligation, to monitor the Services
        for violations of these Legal Terms, take appropriate legal action
        against anyone who violates the law or these Legal Terms, refuse or
        restrict access to the Services, and otherwise manage the Services in a
      ...
      <P>
        ...
        these Legal Terms. The Services are hosted in the United States. If you
        access the Services from another region, you are transferring your data
      ...
      <P>
        ...
        WITHOUT NOTICE OR LIABILITY, DENY ACCESS TO AND USE OF THE SERVICES TO
        ANY PERSON FOR ANY REASON. If we terminate or suspend your account, you
      ...
      <P>
        ...
        construed in accordance with the laws of the State of Nevada applicable
        to agreements made and to be entirely performed within the State of
        Nevada, without regard to its conflict of law principles.
      </P>

      <H2>12. Dispute Resolution</H2>
      <P>
        The parties agree to first attempt to negotiate any Dispute informally
        for at least thirty (30) days before initiating arbitration. If the
        ...
        Arbitration Association. The arbitration will take place in Nevada. Any
        arbitration shall be limited to the Dispute between the parties
        individually; class actions are not permitted.
      </P>

      <H2>13. Corrections</H2>
      <P>
        There may be information on the Services that contains typographical
        errors, inaccuracies, or omissions, including descriptions, pricing, and
        availability. We reserve the right to correct any errors and to change
        or update the information on the Services at any time, without prior
        notice.
      </P>
      ...
      <P>
        ...
        Terms shall not operate as a waiver of such right or provision. If any
        provision or part of a provision of these Legal Terms is determined to
        be unlawful, void, or unenforceable, that provision is deemed severable
