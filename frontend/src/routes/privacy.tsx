...
export const Route = createFileRoute("/privacy")({
  ...
  head: () => ({
    meta: [{ title: "Privacy Policy - Future Form Manufacturing" }],
  }),
})
...
function PrivacyPage() {
  return (
    <LegalLayout title="Privacy Policy" updated="March 30, 2026">
      <P>
        This Privacy Notice for Future Form Manufacturing LLC. (“we,” “us,” or
      ...
      <UL
        items={[
          <>
            Visit our website at https://futureform.com or any website of ours
      ...
      <P>
        ...
        Services, or otherwise when you contact us. The personal information we
      ...
      <P>
        ...
        referring URLs, device name, country, location, and information about
        how and when you use our Services. The information we collect includes
        log and usage data, device data, and location data. Like many
      ...
      <P>
        If you are located in the EU or UK, the GDPR and UK GDPR require us to
        explain the valid legal bases we rely on: consent, legitimate interests,
        legal obligations, and vital interests. If you are located in Canada, we
        may process your information where you have given express or implied
        consent, or where we are legally permitted to process it without consent
      ...
      <P>
        ...
        tracking technologies for analytics and advertising. We may share your
        information with Google Analytics to track and analyze the use of the
        Services. To opt out of being tracked by Google Analytics, visit
      ...
      <P>
        ...
        information, or, if this is not possible, securely store and isolate it
      ...
      <P>
        However, despite our safeguards, no electronic transmission over the
        Internet or information storage technology can be guaranteed to be 100%
        secure. You should only access the Services within a secure environment.
      </P>
      ...
      <P>
        ...
        reasonable measures to promptly delete such data. If you become aware of
        any data we may have collected from children under age 18, please
        contact us at info@futureform.com.
      </P>

      <H2>9. What Are Your Privacy Rights?</H2>
      <Lead>
        In Short: Depending on your state or region of residence, you may have
        rights that allow you greater access to and control over your personal
        information.
      </Lead>
      <P>
        These may include the right to request access, rectification or erasure,
        to restrict processing, to data portability, and not to be subject to
        automated decision-making. To exercise these rights, contact us using
        the details below. If you have questions about your privacy rights, you
        may email us at info@futureform.com.
      </P>

      <H2>10. Controls for Do-Not-Track Features</H2>
      <P>
        Most web browsers include a Do-Not-Track (“DNT”) feature. At this stage,
        no uniform technology standard for recognizing and implementing DNT
        signals has been finalized, so we do not currently respond to DNT
        browser signals.
      </P>

      <H2>11. Do United States Residents Have Specific Privacy Rights?</H2>
      <Lead>
        In Short: If you are a resident of certain US states, you may have the
        right to request access to and receive details about the personal
        information we maintain about you, correct inaccuracies, get a copy of,
        or delete your personal information.
      </Lead>
      <P>
        These rights include the right to know whether we are processing your
        personal data, to access it, to correct inaccuracies, to request
        deletion, to obtain a copy, to non-discrimination for exercising your
        rights, and to opt out of processing for targeted advertising or sale.
        To exercise these rights, you can contact us by submitting a data
        subject access request, by calling toll-free at 800-869-7222, or by
        referring to the contact details below.
      </P>
      ...
      <P>
        The updated version will be indicated by an updated “Revised” date. We
      ...
      <P>
        ...
        update, or delete your personal information, please submit a data
        subject access request or contact us at info@futureform.com.
      </P>
    </LegalLayout>
  )
}
